...
public class ActionManager {
	 ...
	 * @param command The command which represents the action
	...
	/**
	 * Executes an action with the given params. Actionresult is send to the listener
	 * @param command Command which corrosponds to the action
	 * @param params Params
