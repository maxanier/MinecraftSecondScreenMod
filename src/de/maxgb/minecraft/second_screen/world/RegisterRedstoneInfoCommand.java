...
public class RegisterRedstoneInfoCommand implements ICommand{
	 ...
	 * @param player
	 * @param restricts Keeps distance to players block reach distance
	 * @return The position as a MovingObjectPosition, null if not existent
	 * cf: https://github.com/ForgeEssentials/ForgeEssentialsMain/blob/master/src/main/java/com/forgeessentials/util/FunctionHelper.java
	 */
