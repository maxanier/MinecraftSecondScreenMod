...
public class PROTOKOLL {
	public static final String REGISTER_S_PLAYERINFO_LISTENER = "r-spi"; // <username>
	public static final String UNREGISTER_S_PLAYERINFO_LISTENER = "ur-spi"; // <username>
	public static final String UNREGISTER_ALL_LISTENER = "ur-all";
	public static final String S_PLAYERINFO_LISTENER = "spi";
